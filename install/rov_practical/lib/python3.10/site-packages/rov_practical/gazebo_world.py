...
class GazeboWorld(Node):
    def __init__(self):
        ...
        self.resized_depth_img = self.create_publisher(Image, '/video_frames', 10)
        self.resized_rgb_img = self.create_publisher(Image, '/video_frames', 10)

        self.object_state_sub = self.create_subscription(ModelStates, 'gazebo/model_states', self.ModelStateCallBack, 10)
        self.rgb_image_sub = self.create_subscription(Image, '/video_frames', self.RGBImageCallBack, 10)
        self.depth_image_sub = self.create_subscription(Image, '/video_frames', self.DepthImageCallBack, 10)
