...
#include "kobuki_ros_interfaces/msg/detail/button_event__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const kobuki_ros_interfaces::msg::ButtonEvent & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  kobuki_ros_interfaces::msg::ButtonEvent & ros_message)
{
  // Member: button
  cdr >> ros_message.button;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = kobuki_ros_interfaces::msg::ButtonEvent;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const kobuki_ros_interfaces::msg::ButtonEvent *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<kobuki_ros_interfaces::msg::ButtonEvent *>(
    untyped_ros_message);
...
{
  return &kobuki_ros_interfaces::msg::typesupport_fastrtps_cpp::_ButtonEvent__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, kobuki_ros_interfaces, msg, ButtonEvent)() {
  return &kobuki_ros_interfaces::msg::typesupport_fastrtps_cpp::_ButtonEvent__handle;
}
