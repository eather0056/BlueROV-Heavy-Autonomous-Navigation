...
#include "kobuki_ros_interfaces/msg/detail/sound__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const kobuki_ros_interfaces::msg::Sound & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  kobuki_ros_interfaces::msg::Sound & ros_message)
{
  // Member: value
  cdr >> ros_message.value;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = kobuki_ros_interfaces::msg::Sound;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const kobuki_ros_interfaces::msg::Sound *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<kobuki_ros_interfaces::msg::Sound *>(
    untyped_ros_message);
...
{
  return &kobuki_ros_interfaces::msg::typesupport_fastrtps_cpp::_Sound__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, kobuki_ros_interfaces, msg, Sound)() {
  return &kobuki_ros_interfaces::msg::typesupport_fastrtps_cpp::_Sound__handle;
}
