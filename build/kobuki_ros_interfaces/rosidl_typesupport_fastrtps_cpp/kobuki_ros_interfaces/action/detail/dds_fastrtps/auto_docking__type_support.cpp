  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = kobuki_ros_interfaces::action::AutoDocking_Goal;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = kobuki_ros_interfaces::action::AutoDocking_Result;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = kobuki_ros_interfaces::action::AutoDocking_Feedback;
    is_plain =
      (
      offsetof(DataType, text) +
      last_member_size
...
// functions for kobuki_ros_interfaces::action::AutoDocking_Goal already declared above
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = kobuki_ros_interfaces::action::AutoDocking_SendGoal_Request;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = kobuki_ros_interfaces::action::AutoDocking_SendGoal_Response;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = kobuki_ros_interfaces::action::AutoDocking_GetResult_Request;
    is_plain =
      (
...
// forward declaration of message dependencies and their conversion functions
// functions for kobuki_ros_interfaces::action::AutoDocking_Result already declared above
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = kobuki_ros_interfaces::action::AutoDocking_GetResult_Response;
    is_plain =
      (
...
// functions for kobuki_ros_interfaces::action::AutoDocking_Feedback already declared above
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = kobuki_ros_interfaces::action::AutoDocking_FeedbackMessage;
    is_plain =
      (
