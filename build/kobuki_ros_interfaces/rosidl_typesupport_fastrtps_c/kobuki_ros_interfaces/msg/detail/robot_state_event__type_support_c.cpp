  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = kobuki_ros_interfaces__msg__RobotStateEvent;
    is_plain =
      (
...
static size_t _RobotStateEvent__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_kobuki_ros_interfaces__msg__RobotStateEvent(
